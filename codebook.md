#Smart Phone Accelerometer Code Book

This code book describes the process for turning raw data from accelerometer sensors in Samsung Galaxy smart phones into tidy data. First it is important to review the data that is being manipulated.
